...
const tipoRequisicaoList = (props) => {
  ...
  <div>   
    <div>
      <h4>Listagem de Tipo Requisicao</h4>
      <button
        button
        type="button"
      ...
      <div className="card">
        <DataTable value={props.tipoRequisicoes} responsiveLayout="scroll" selectionMode="single" paginator paginatorTemplate={template2} rows={8} 
